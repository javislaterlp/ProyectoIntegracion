...
public class NVPAPICaller
{
    ...
    public string APIUsername = "javierho93-facilitator_api1.hotmail.com";
    private string APIPassword = "F5RTR3Q9JXZ44DXL";
    private string APISignature = "A3jkJlnMVvvhcpQt4odI0lOcq0ZgAti2CYLGaUqVElr23gk1m9CDZH.k";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        encoder["BRANDNAME"] = "ASP Game Shop Sample Application";
